...
import calculateAbsoluteDailyIncrease from './calculate-absolute-daily-increase';

jest.mock('./calculate-absolute-daily-increase', () => jest.fn());
